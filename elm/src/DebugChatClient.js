...
var _scameronde$experiment_elm_chat$Lens$lens = F2(
	function (get, set) {
		return A3(
			_scameronde$experiment_elm_chat$Lens$Lens,
			get,
			set,
			_elm_lang$core$Basics$flip(set));
	});
var _scameronde$experiment_elm_chat$Lens_ops = _scameronde$experiment_elm_chat$Lens_ops || {};
_scameronde$experiment_elm_chat$Lens_ops['.'] = F2(
	function (lensAB, lensBC) {
		var get = function (_p0) {
			return lensBC.get(
				lensAB.get(_p0));
		};
		var set = F2(
		...
		return A2(_scameronde$experiment_elm_chat$Lens$lens, get, set);
	});
var _scameronde$experiment_elm_chat$Lens$compose = F2(
	function (x, y) {
...
var _scameronde$experiment_elm_chat$BusinessTypes$Participant = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _scameronde$experiment_elm_chat$BusinessTypes$ChatRoom = F2(
	function (a, b) {
		return {id: a, title: b};
	});
var _scameronde$experiment_elm_chat$BusinessTypes$ChatRegistration = F2(
	function (a, b) {
		return {participant: a, chatRoom: b};
	});
var _scameronde$experiment_elm_chat$BusinessTypes$Message = function (a) {
	return {message: a};
};
var _scameronde$experiment_elm_chat$BusinessTypes$MessageLog = function (a) {
	return {messageLog: a};
};
var _scameronde$experiment_elm_chat$BusinessTypes$Id = function (a) {
	return {ctor: 'Id', _0: a};
};
var _scameronde$experiment_elm_chat$BusinessTypes$NewMessage = function (a) {
	return {ctor: 'NewMessage', _0: a};
};
var _scameronde$experiment_elm_chat$BusinessTypes$Register = function (a) {
	return {ctor: 'Register', _0: a};
};

var _scameronde$experiment_elm_chat$Model$insteadDo = F2(
	function (cmd, r) {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Tuple$first(r),
			_1: cmd
		};
	});
var _scameronde$experiment_elm_chat$Model$andThenDo = F2(
	function (cmd, r) {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_elm_lang$core$Tuple$first(r),
			{
				ctor: '::',
				_0: _elm_lang$core$Tuple$second(r),
				_1: {
					ctor: '::',
					_0: cmd,
					_1: {ctor: '[]'}
...
var _scameronde$experiment_elm_chat$Model$modify = _elm_lang$core$Tuple$mapFirst;
var _scameronde$experiment_elm_chat$Model$map = F3(
	function (f, g, r) {
		return {
			ctor: '_Tuple2',
			_0: f(
			...
			_1: A2(
				...
				g,
				_elm_lang$core$Tuple$second(r))
		};
	});
var _scameronde$experiment_elm_chat$Model$run = function (_p0) {
	var _p1 = _p0;
	return _p1._0;
};
var _scameronde$experiment_elm_chat$Model$Creator = function (a) {
	return {ctor: 'Creator', _0: a};
};
var _scameronde$experiment_elm_chat$Model$pure = _scameronde$experiment_elm_chat$Model$Creator;
var _scameronde$experiment_elm_chat$Model$create = function (f) {
	return _scameronde$experiment_elm_chat$Model$pure(
		{ctor: '_Tuple2', _0: f, _1: _elm_lang$core$Platform_Cmd$none});
};
var _scameronde$experiment_elm_chat$Model$hoist = F2(
	function (f, _p2) {
		var _p3 = _p2;
		return _scameronde$experiment_elm_chat$Model$Creator(
			{
				ctor: '_Tuple2',
				_0: _p3._0._0,
				_1: A2(_elm_lang$core$Platform_Cmd$map, f, _p3._0._1)
			});
	});
var _scameronde$experiment_elm_chat$Model$apply = F2(
	function (_p5, _p4) {
		var _p6 = _p5;
		var _p7 = _p4;
		return _scameronde$experiment_elm_chat$Model$Creator(
...
var _scameronde$experiment_elm_chat$Model$combine = F3(
	function (msgMapper, innerInit, creator) {
		return A2(
			_scameronde$experiment_elm_chat$Model$apply,
			creator,
			A2(
				_scameronde$experiment_elm_chat$Model$hoist,
				msgMapper,
				_scameronde$experiment_elm_chat$Model$pure(innerInit)));
	});
var _scameronde$experiment_elm_chat$Model$set = F2(
	function (value, creator) {
		return A3(
			_scameronde$experiment_elm_chat$Model$combine,
			_elm_lang$core$Basics$identity,
			{ctor: '_Tuple2', _0: value, _1: _elm_lang$core$Platform_Cmd$none},
			creator);
	});

var _scameronde$experiment_elm_chat$Json$decoderForMessageLog = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'messageLog',
	_elm_lang$core$Json_Decode$string,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_scameronde$experiment_elm_chat$BusinessTypes$MessageLog));
var _scameronde$experiment_elm_chat$Json$encodeMessageLog = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'messageLog',
				_1: _elm_lang$core$Json_Encode$string(record.messageLog)
			},
			_1: {ctor: '[]'}
		});
};
var _scameronde$experiment_elm_chat$Json$decoderForMessage = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'message',
	_elm_lang$core$Json_Decode$string,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_scameronde$experiment_elm_chat$BusinessTypes$Message));
var _scameronde$experiment_elm_chat$Json$encodeMessage = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'message',
				_1: _elm_lang$core$Json_Encode$string(record.message)
			},
			_1: {ctor: '[]'}
		});
};
var _scameronde$experiment_elm_chat$Json$decoderForId = A2(_elm_lang$core$Json_Decode$map, _scameronde$experiment_elm_chat$BusinessTypes$Id, _elm_lang$core$Json_Decode$string);
var _scameronde$experiment_elm_chat$Json$decoderForParticipant = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'name',
	_elm_lang$core$Json_Decode$string,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'id',
		_scameronde$experiment_elm_chat$Json$decoderForId,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_scameronde$experiment_elm_chat$BusinessTypes$Participant)));
var _scameronde$experiment_elm_chat$Json$decoderForChatRoom = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'title',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'id',
		_scameronde$experiment_elm_chat$Json$decoderForId,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_scameronde$experiment_elm_chat$BusinessTypes$ChatRoom)));
var _scameronde$experiment_elm_chat$Json$decoderForChatRooms = _elm_lang$core$Json_Decode$list(_scameronde$experiment_elm_chat$Json$decoderForChatRoom);
var _scameronde$experiment_elm_chat$Json$decoderForChatRegistration = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'chatRoom',
	_scameronde$experiment_elm_chat$Json$decoderForChatRoom,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'participant',
		_scameronde$experiment_elm_chat$Json$decoderForParticipant,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_scameronde$experiment_elm_chat$BusinessTypes$ChatRegistration)));
var _scameronde$experiment_elm_chat$Json$encodeId = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Json_Encode$string(_p1._0);
};
var _scameronde$experiment_elm_chat$Json$encodeParticipant = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'id',
				_1: _scameronde$experiment_elm_chat$Json$encodeId(record.id)
			},
			_1: {
				ctor: '::',
				_0: {
...
var _scameronde$experiment_elm_chat$Json$encodeChatRoom = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _scameronde$experiment_elm_chat$Json$encodeChatRooms = function (list) {
	return _elm_lang$core$Json_Encode$list(
		A2(_elm_lang$core$List$map, _scameronde$experiment_elm_chat$Json$encodeChatRoom, list));
};
var _scameronde$experiment_elm_chat$Json$encodeChatRegistration = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'participant',
				_1: _scameronde$experiment_elm_chat$Json$encodeParticipant(record.participant)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'chatRoom',
					_1: _scameronde$experiment_elm_chat$Json$encodeChatRoom(record.chatRoom)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _scameronde$experiment_elm_chat$Json$encodeChatCommand = function (record) {
	var _p2 = record;
	if (_p2.ctor === 'Register') {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'command',
					_1: _elm_lang$core$Json_Encode$string('register')
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'registration',
						_1: _scameronde$experiment_elm_chat$Json$encodeChatRegistration(_p2._0)
					},
					_1: {ctor: '[]'}
				}
			});
		...
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'message',
						_1: _scameronde$experiment_elm_chat$Json$encodeMessage(_p2._0)
					},
					_1: {ctor: '[]'}
				}
			});
...
var _scameronde$experiment_elm_chat$RestClient$delete = function (url) {
	return _elm_lang$http$Http$request(
		{
			method: 'DELETE',
			headers: {ctor: '[]'},
...
var _scameronde$experiment_elm_chat$RestClient$deleteChatRoom = F2(
	function (_p1, msg) {
		var _p2 = _p1;
		var deleteChatRoomRequest = _scameronde$experiment_elm_chat$RestClient$delete(
			A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:4567/chatRoom/', _p2._0));
		return A2(_elm_lang$http$Http$send, msg, deleteChatRoomRequest);
	});
var _scameronde$experiment_elm_chat$RestClient$getChatRoom = F2(
	function (_p3, msg) {
		var _p4 = _p3;
		var getChatRoomRequest = A2(
			_elm_lang$http$Http$get,
			A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:4567/chatRoom/', _p4._0),
			_scameronde$experiment_elm_chat$Json$decoderForMessageLog);
		return A2(_elm_lang$http$Http$send, msg, getChatRoomRequest);
	});
var _scameronde$experiment_elm_chat$RestClient$getChatRooms = function (msg) {
	var getChatRoomsRequest = A2(_elm_lang$http$Http$get, 'http://localhost:4567/chatRoom', _scameronde$experiment_elm_chat$Json$decoderForChatRooms);
	return A2(_elm_lang$http$Http$send, msg, getChatRoomsRequest);
};
var _scameronde$experiment_elm_chat$RestClient$postChatRoom = F2(
	function (chatRoom, msg) {
		var postChatRoomRequest = A3(
			_elm_lang$http$Http$post,
			'http://localhost:4567/chatRoom',
			_elm_lang$http$Http$jsonBody(
				_scameronde$experiment_elm_chat$Json$encodeChatRoom(chatRoom)),
			_scameronde$experiment_elm_chat$Json$decoderForId);
		return A2(_elm_lang$http$Http$send, msg, postChatRoomRequest);
	});
var _scameronde$experiment_elm_chat$RestClient$postParticipant = F2(
	function (participant, msg) {
		var postParticipantRequest = A3(
			_elm_lang$http$Http$post,
			'http://localhost:4567/participant',
			_elm_lang$http$Http$jsonBody(
				_scameronde$experiment_elm_chat$Json$encodeParticipant(participant)),
			_scameronde$experiment_elm_chat$Json$decoderForId);
		return A2(_elm_lang$http$Http$send, msg, postParticipantRequest);
	});
var _scameronde$experiment_elm_chat$RestClient$getParticipant = F2(
	function (participantName, msg) {
		var getParticipantRequest = A2(
			_elm_lang$http$Http$get,
			A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:4567/participant/', participantName),
			_scameronde$experiment_elm_chat$Json$decoderForParticipant);
		return A2(_elm_lang$http$Http$send, msg, getParticipantRequest);
	});

var _scameronde$experiment_elm_chat$Cmd$toCmd = function (message) {
	return A2(
		_elm_lang$core$Task$perform,
		_elm_lang$core$Basics$identity,
...
var _scameronde$experiment_elm_chat$ChatRooms$rowClass = F2(
	function (chatRoom, selection) {
		return _elm_lang$core$Native_Utils.eq(
			selection,
			_elm_lang$core$Maybe$Just(chatRoom.id)) ? 'info' : '';
	});
var _scameronde$experiment_elm_chat$ChatRooms$findChatRoom = F2(
	function (id, chatRooms) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (chatRoom) {
					return _elm_lang$core$Native_Utils.eq(chatRoom.id, id);
				},
				chatRooms));
	});
var _scameronde$experiment_elm_chat$ChatRooms$Model = F5(
	function (a, b, c, d, e) {
		return {chatRooms: a, selectedChatRoomId: b, chatRoomIdToDelete: c, newChatRoomTitle: d, error: e};
	});
var _scameronde$experiment_elm_chat$ChatRooms$Failure = function (a) {
	return {ctor: 'Failure', _0: a};
};
var _scameronde$experiment_elm_chat$ChatRooms$Success = function (a) {
	return {ctor: 'Success', _0: a};
};
var _scameronde$experiment_elm_chat$ChatRooms$Updating = function (a) {
	return {ctor: 'Updating', _0: a};
};
var _scameronde$experiment_elm_chat$ChatRooms$Loading = {ctor: 'Loading'};
var _scameronde$experiment_elm_chat$ChatRooms$NotAsked = {ctor: 'NotAsked'};
...
var _scameronde$experiment_elm_chat$ChatRooms$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _scameronde$experiment_elm_chat$ChatRooms$GetChatRooms);
};
var _scameronde$experiment_elm_chat$ChatRooms$PostChatRoomResult = function (a) {
	return {ctor: 'PostChatRoomResult', _0: a};
};
var _scameronde$experiment_elm_chat$ChatRooms$PostChatRoom = function (a) {
	return {ctor: 'PostChatRoom', _0: a};
};
var _scameronde$experiment_elm_chat$ChatRooms$ChangeField = F2(
	function (a, b) {
		return {ctor: 'ChangeField', _0: a, _1: b};
	});
var _scameronde$experiment_elm_chat$ChatRooms$DeleteChatRoomResult = function (a) {
	return {ctor: 'DeleteChatRoomResult', _0: a};
};
var _scameronde$experiment_elm_chat$ChatRooms$DeleteChatRoomCancel = {ctor: 'DeleteChatRoomCancel'};
var _scameronde$experiment_elm_chat$ChatRooms$DeleteChatRoomAcknowledge = {ctor: 'DeleteChatRoomAcknowledge'};
var _scameronde$experiment_elm_chat$ChatRooms$dialogConfig = function (model) {
	return {
		closeMessage: _elm_lang$core$Maybe$Just(_scameronde$experiment_elm_chat$ChatRooms$DeleteChatRoomAcknowledge),
		...
		header: _elm_lang$core$Maybe$Just(
			A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Delete chat room'),
					_1: {ctor: '[]'}
				})),
		body: _elm_lang$core$Maybe$Just(
			_elm_lang$html$Html$text('Really delete chat room?')),
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_scameronde$experiment_elm_chat$ChatRooms$DeleteChatRoomAcknowledge),
								_1: {ctor: '[]'}
							}
						},
						{
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_scameronde$experiment_elm_chat$ChatRooms$DeleteChatRoomCancel),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _scameronde$experiment_elm_chat$ChatRooms$viewDialog = function (model) {
	return _krisajenkins$elm_dialog$Dialog$view(
		(!_elm_lang$core$Native_Utils.eq(model.chatRoomIdToDelete, _elm_lang$core$Maybe$Nothing)) ? _elm_lang$core$Maybe$Just(
			_scameronde$experiment_elm_chat$ChatRooms$dialogConfig(model)) : _elm_lang$core$Maybe$Nothing);
};
var _scameronde$experiment_elm_chat$ChatRooms$DeleteChatRoom = function (a) {
	return {ctor: 'DeleteChatRoom', _0: a};
};
var _scameronde$experiment_elm_chat$ChatRooms$SelectChatRoom = function (a) {
	return {ctor: 'SelectChatRoom', _0: a};
};
var _scameronde$experiment_elm_chat$ChatRooms$viewChatRoomList = F2(
	function (chatRooms, selection) {
		return A2(
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Available Chat Rooms'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
								...
								return A2(
									_elm_lang$html$Html$tr,
									{
										...
										_0: _elm_lang$html$Html_Attributes$class(
											A2(_scameronde$experiment_elm_chat$ChatRooms$rowClass, chatRoom, selection)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$td,
											{
												...
												_0: _elm_lang$html$Html_Events$onClick(
													_scameronde$experiment_elm_chat$ChatRooms$SelectChatRoom(chatRoom.id)),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(chatRoom.title),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
													...
													_0: A2(
														_elm_lang$html$Html$button,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(
																	_scameronde$experiment_elm_chat$ChatRooms$DeleteChatRoom(chatRoom.id)),
																_1: {ctor: '[]'}
															}
														},
														{
...
var _scameronde$experiment_elm_chat$ChatRooms$viewChatRooms = function (model) {
	var _p0 = function () {
		var _p1 = model.chatRooms;
		switch (_p1.ctor) {
			case 'NotAsked':
				return {
					ctor: '_Tuple3',
			...
			case 'Updating':
				return {ctor: '_Tuple3', _0: 'updating ...', _1: _p1._0, _2: model.selectedChatRoomId};
			case 'Success':
				return {ctor: '_Tuple3', _0: 'OK', _1: _p1._0, _2: model.selectedChatRoomId};
			default:
				return {
					ctor: '_Tuple3',
					_0: A2(_elm_lang$core$Basics_ops['++'], 'Error: ', _p1._0),
					_1: {ctor: '[]'},
					_2: _elm_lang$core$Maybe$Nothing
				};
		}
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_scameronde$experiment_elm_chat$ChatRooms$viewChatRoomList, list, selection),
				_1: {ctor: '[]'}
			}
		});
};
...
var _scameronde$experiment_elm_chat$ChatRooms$selectFromAvailableChatRoom = F3(
...
var _scameronde$experiment_elm_chat$ChatRooms$update = F2(
	function (msg, model) {
		var _p8 = msg;
		switch (_p8.ctor) {
			case 'SelectChatRoom':
				...
				return {
					...
					_0: A2(
						...
						function () {
							...
							switch (_p10.ctor) {
								case 'Success':
									return _scameronde$experiment_elm_chat$ChatRooms$Updating(_p10._0);
								case 'Updating':
									return _scameronde$experiment_elm_chat$ChatRooms$Updating(_p10._0);
								default:
									return _scameronde$experiment_elm_chat$ChatRooms$Loading;
							}
						}(),
						model),
					_1: _scameronde$experiment_elm_chat$RestClient$getChatRooms(_scameronde$experiment_elm_chat$ChatRooms$GetChatRoomsResult)
...
var _scameronde$experiment_elm_chat$ChatRooms$viewNewChatRoom = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(
				_scameronde$experiment_elm_chat$ChatRooms$PostChatRoom(model)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$for('titleInput'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('New Chat Room'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('titleInput'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$type_('text'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.newChatRoomTitle),
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_0: _elm_lang$html$Html_Events$onInput(
													_scameronde$experiment_elm_chat$ChatRooms$ChangeField(_scameronde$experiment_elm_chat$ChatRooms$Title)),
												_1: {ctor: '[]'}
											}
										}
									}
							...
							_0: _elm_lang$html$Html_Attributes$disabled(
								_elm_lang$core$Native_Utils.eq(
									_elm_lang$core$String$length(
										_elm_lang$core$String$trim(model.newChatRoomTitle)),
									0)),
							_1: {ctor: '[]'}
						}
					},
...
var _scameronde$experiment_elm_chat$ChatRooms$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Chat Room Selection'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _scameronde$experiment_elm_chat$ChatRooms$viewChatRooms(model),
				_1: {
					ctor: '::',
					_0: _scameronde$experiment_elm_chat$ChatRooms$viewNewChatRoom(model),
					_1: {
						ctor: '::',
						_0: _scameronde$experiment_elm_chat$ChatRooms$viewDialog(model),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _scameronde$experiment_elm_chat$WebSocketClient$jsonAsString = _elm_lang$core$Json_Encode$encode(0);
var _scameronde$experiment_elm_chat$WebSocketClient$sendMessage = function (message) {
	return A2(
		_elm_lang$websocket$WebSocket$send,
		'ws://localhost:4567/chat',
		_scameronde$experiment_elm_chat$WebSocketClient$jsonAsString(
			_scameronde$experiment_elm_chat$Json$encodeChatCommand(
				_scameronde$experiment_elm_chat$BusinessTypes$NewMessage(message))));
};
var _scameronde$experiment_elm_chat$WebSocketClient$sendRegistration = function (registration) {
	return A2(
		_elm_lang$websocket$WebSocket$send,
		'ws://localhost:4567/chat',
		_scameronde$experiment_elm_chat$WebSocketClient$jsonAsString(
			_scameronde$experiment_elm_chat$Json$encodeChatCommand(
				_scameronde$experiment_elm_chat$BusinessTypes$Register(registration))));
};

var _scameronde$experiment_elm_chat$ChatRoom$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ChangeField':
...
var _scameronde$experiment_elm_chat$ChatRoom$Model = F5(
	function (a, b, c, d, e) {
		return {participant: a, chatRoom: b, message: c, messageLog: d, error: e};
	});
var _scameronde$experiment_elm_chat$ChatRoom$ReceivedMessage = function (a) {
	return {ctor: 'ReceivedMessage', _0: a};
};
var _scameronde$experiment_elm_chat$ChatRoom$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:4567/chat', _scameronde$experiment_elm_chat$ChatRoom$ReceivedMessage);
};
var _scameronde$experiment_elm_chat$ChatRoom$SendMessage = function (a) {
	return {ctor: 'SendMessage', _0: a};
};
var _scameronde$experiment_elm_chat$ChatRoom$ChangeField = F2(
	function (a, b) {
		return {ctor: 'ChangeField', _0: a, _1: b};
	});
var _scameronde$experiment_elm_chat$ChatRoom$SetChatHistory = function (a) {
	return {ctor: 'SetChatHistory', _0: a};
};
var _scameronde$experiment_elm_chat$ChatRoom$init = F2(
	function (participant, chatRoom) {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			{participant: participant, chatRoom: chatRoom, message: '', messageLog: '', error: ''},
			{
				ctor: '::',
				_0: _scameronde$experiment_elm_chat$WebSocketClient$sendRegistration(
					A2(_scameronde$experiment_elm_chat$BusinessTypes$ChatRegistration, participant, chatRoom)),
				_1: {
					ctor: '::',
					_0: A2(_scameronde$experiment_elm_chat$RestClient$getChatRoom, chatRoom.id, _scameronde$experiment_elm_chat$ChatRoom$SetChatHistory),
					_1: {ctor: '[]'}
				}
			});
	});
var _scameronde$experiment_elm_chat$ChatRoom$NewMessage = {ctor: 'NewMessage'};
var _scameronde$experiment_elm_chat$ChatRoom$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(model.chatRoom.title),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					_elm_lang$html$Html$textarea,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value(model.messageLog),
									_1: {ctor: '[]'}
								}
							}
						}
					...
					_0: A2(
						_elm_lang$html$Html$form,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onSubmit(
									_scameronde$experiment_elm_chat$ChatRoom$SendMessage(model.message)),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$size(30),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$placeholder(
													A2(_elm_lang$core$Basics_ops['++'], model.participant.name, ': Enter message')),
												_1: {
													ctor: '::',
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(
															_scameronde$experiment_elm_chat$ChatRoom$ChangeField(_scameronde$experiment_elm_chat$ChatRoom$NewMessage)),
														_1: {ctor: '[]'}
													}
												}
											}
...
var _scameronde$experiment_elm_chat$Chat$ChatRoomMsg = function (a) {
	return {ctor: 'ChatRoomMsg', _0: a};
};
var _scameronde$experiment_elm_chat$Chat$ChatRoomsMsg = function (a) {
	return {ctor: 'ChatRoomsMsg', _0: a};
};
var _scameronde$experiment_elm_chat$Chat$init = function (participant) {
	return _scameronde$experiment_elm_chat$Model$run(
		A3(
			_scameronde$experiment_elm_chat$Model$combine,
			_scameronde$experiment_elm_chat$Chat$ChatRoomsMsg,
			_scameronde$experiment_elm_chat$ChatRooms$init,
			A2(
				_scameronde$experiment_elm_chat$Model$set,
				_elm_lang$core$Maybe$Nothing,
				A2(
					_scameronde$experiment_elm_chat$Model$set,
					participant,
					_scameronde$experiment_elm_chat$Model$create(_scameronde$experiment_elm_chat$Chat$Model)))));
};
var _scameronde$experiment_elm_chat$Chat$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'ChatRoomsMsg') {
			switch (_p0._0.ctor) {
				case 'Selected':
					return A3(
...
var _scameronde$experiment_elm_chat$Chat$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						_scameronde$experiment_elm_chat$Chat$ChatRoomsMsg,
						_scameronde$experiment_elm_chat$ChatRooms$view(model.chatRoomsModel)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _scameronde$experiment_elm_chat$Chat$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				...
				_scameronde$experiment_elm_chat$Chat$ChatRoomsMsg,
				_scameronde$experiment_elm_chat$ChatRooms$subscriptions(model.chatRoomsModel)),
			_1: {
				ctor: '::',
				_0: function () {
...
var _scameronde$experiment_elm_chat$NavBar$viewMain = function (elements) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _scameronde$experiment_elm_chat$NavBar$viewNavBar = function (model) {
	return A2(
...
var _scameronde$experiment_elm_chat$Login$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _scameronde$experiment_elm_chat$Login$noName = function (model) {
	return _elm_lang$core$String$isEmpty(model.name);
};
var _scameronde$experiment_elm_chat$Login$noError = function (model) {
	return _elm_lang$core$String$isEmpty(model.error);
};
var _scameronde$experiment_elm_chat$Login$viewErrorMsg = F2(
	function (model, msg) {
		return _elm_lang$core$String$isEmpty(model.error) ? A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{ctor: '[]'}) : A2(
			_elm_lang$html$Html$div,
...
var _scameronde$experiment_elm_chat$Login$updatedErrorMessage = F2(
	function (name, error) {
...
var _scameronde$experiment_elm_chat$Login$GetParticipantResult = function (a) {
	return {ctor: 'GetParticipantResult', _0: a};
};
var _scameronde$experiment_elm_chat$Login$GetParticipant = {ctor: 'GetParticipant'};
var _scameronde$experiment_elm_chat$Login$Login = function (a) {
	return {ctor: 'Login', _0: a};
};
var _scameronde$experiment_elm_chat$Login$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ChangeField':
...
var _scameronde$experiment_elm_chat$Login$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A2(_scameronde$experiment_elm_chat$Login$viewErrorMsg, model, 'Wrong Credentials!'),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$form,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onSubmit(_scameronde$experiment_elm_chat$Login$GetParticipant),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$for('nameInput'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('nameInput'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$type_('text'),
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(
															_scameronde$experiment_elm_chat$Login$ChangeField(_scameronde$experiment_elm_chat$Login$Name)),
														_1: {ctor: '[]'}
													}
												}
											}
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$disabled(
											_scameronde$experiment_elm_chat$Login$noName(model)),
										_1: {ctor: '[]'}
									}
								},
								{
...
var _scameronde$experiment_elm_chat$ChatClient$ChatMsg = function (a) {
	return {ctor: 'ChatMsg', _0: a};
};
var _scameronde$experiment_elm_chat$ChatClient$LoginMsg = function (a) {
	return {ctor: 'LoginMsg', _0: a};
};
var _scameronde$experiment_elm_chat$ChatClient$viewMainArea = function (model) {
	var _p0 = model;
	if (_p0.ctor === 'LoginModel') {
		return A2(
			_elm_lang$html$Html$map,
			_scameronde$experiment_elm_chat$ChatClient$LoginMsg,
			_scameronde$experiment_elm_chat$Login$view(_p0._0));
	} else {
		return A2(
			_elm_lang$html$Html$map,
			_scameronde$experiment_elm_chat$ChatClient$ChatMsg,
			_scameronde$experiment_elm_chat$Chat$view(_p0._0));
	}
};
var _scameronde$experiment_elm_chat$ChatClient$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _scameronde$experiment_elm_chat$NavBar$viewNavBar(model),
			_1: {
				ctor: '::',
				_0: _scameronde$experiment_elm_chat$NavBar$viewMain(
					{
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('view-area'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _scameronde$experiment_elm_chat$ChatClient$viewMainArea(model),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _scameronde$experiment_elm_chat$ChatClient$subscriptions = function (model) {
	var _p1 = model;
	if (_p1.ctor === 'LoginModel') {
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_scameronde$experiment_elm_chat$ChatClient$LoginMsg,
			_scameronde$experiment_elm_chat$Login$subscriptions(_p1._0));
	} else {
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_scameronde$experiment_elm_chat$ChatClient$ChatMsg,
			_scameronde$experiment_elm_chat$Chat$subscriptions(_p1._0));
	}
};
var _scameronde$experiment_elm_chat$ChatClient$ChatModel = function (a) {
	return {ctor: 'ChatModel', _0: a};
};
var _scameronde$experiment_elm_chat$ChatClient$LoginModel = function (a) {
	return {ctor: 'LoginModel', _0: a};
};
var _scameronde$experiment_elm_chat$ChatClient$init = A3(_scameronde$experiment_elm_chat$Model$map, _scameronde$experiment_elm_chat$ChatClient$LoginModel, _scameronde$experiment_elm_chat$ChatClient$LoginMsg, _scameronde$experiment_elm_chat$Login$init);
var _scameronde$experiment_elm_chat$ChatClient$update = F2(
	function (msg, model) {
		var _p2 = {ctor: '_Tuple2', _0: msg, _1: model};
		_v2_3:
		do {
			if (_p2.ctor === '_Tuple2') {
				if (_p2._0.ctor === 'LoginMsg') {
					if (_p2._1.ctor === 'LoginModel') {
						if (_p2._0._0.ctor === 'Login') {
							return A3(
								_scameronde$experiment_elm_chat$Model$map,
								_scameronde$experiment_elm_chat$ChatClient$ChatModel,
								_scameronde$experiment_elm_chat$ChatClient$ChatMsg,
								_scameronde$experiment_elm_chat$Chat$init(_p2._0._0._0));
						} else {
							return A3(
								_scameronde$experiment_elm_chat$Model$map,
								_scameronde$experiment_elm_chat$ChatClient$LoginModel,
								_scameronde$experiment_elm_chat$ChatClient$LoginMsg,
								A2(_scameronde$experiment_elm_chat$Login$update, _p2._0._0, _p2._1._0));
						}
					} else {
						break _v2_3;
					}
				} else {
					if (_p2._1.ctor === 'ChatModel') {
						return A3(
							_scameronde$experiment_elm_chat$Model$map,
							_scameronde$experiment_elm_chat$ChatClient$ChatModel,
							_scameronde$experiment_elm_chat$ChatClient$ChatMsg,
							A2(_scameronde$experiment_elm_chat$Chat$update, _p2._0._0, _p2._1._0));
					} else {
						break _v2_3;
					}
				}
		...
		return A2(
			...
			'Stray combiniation of Model and Message found',
...
var _scameronde$experiment_elm_chat$DebugChatClient$Model = F2(
	function (a, b) {
		return {debug: a, chatClientModel: b};
	});
var _scameronde$experiment_elm_chat$DebugChatClient$ChatClientMsg = function (a) {
	return {ctor: 'ChatClientMsg', _0: a};
};
var _scameronde$experiment_elm_chat$DebugChatClient$init = function (flags) {
	return _scameronde$experiment_elm_chat$Model$run(
		A3(
			_scameronde$experiment_elm_chat$Model$combine,
			_scameronde$experiment_elm_chat$DebugChatClient$ChatClientMsg,
			_scameronde$experiment_elm_chat$ChatClient$init,
			A2(
				_scameronde$experiment_elm_chat$Model$set,
				flags.debug,
				_scameronde$experiment_elm_chat$Model$create(_scameronde$experiment_elm_chat$DebugChatClient$Model))));
};
var _scameronde$experiment_elm_chat$DebugChatClient$update = F2(
	function (_p0, model) {
		var _p1 = _p0;
		return A3(
			_scameronde$experiment_elm_chat$Model$map,
...
var _scameronde$experiment_elm_chat$DebugChatClient$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$map,
				_scameronde$experiment_elm_chat$DebugChatClient$ChatClientMsg,
				_scameronde$experiment_elm_chat$ChatClient$view(model.chatClientModel)),
			_1: {
				ctor: '::',
				_0: model.debug ? A2(
					_elm_lang$html$Html$div,
...
var _scameronde$experiment_elm_chat$DebugChatClient$subscriptions = function (model) {
	return A2(
		_elm_lang$core$Platform_Sub$map,
		_scameronde$experiment_elm_chat$DebugChatClient$ChatClientMsg,
		_scameronde$experiment_elm_chat$ChatClient$subscriptions(model.chatClientModel));
};
var _scameronde$experiment_elm_chat$DebugChatClient$main = _elm_lang$html$Html$programWithFlags(
	{init: _scameronde$experiment_elm_chat$DebugChatClient$init, update: _scameronde$experiment_elm_chat$DebugChatClient$update, view: _scameronde$experiment_elm_chat$DebugChatClient$view, subscriptions: _scameronde$experiment_elm_chat$DebugChatClient$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (debug) {
...
var Elm = {};
Elm['DebugChatClient'] = Elm['DebugChatClient'] || {};
if (typeof _scameronde$experiment_elm_chat$DebugChatClient$main !== 'undefined') {
    _scameronde$experiment_elm_chat$DebugChatClient$main(Elm['DebugChatClient'], 'DebugChatClient', undefined);
}
