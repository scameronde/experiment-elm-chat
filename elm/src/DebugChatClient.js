...
var _scameronde$experiment_elm_chat$ChatRooms$rowClass = F2(
	function (chatRoom, selection) {
		return _elm_lang$core$Native_Utils.eq(
			selection,
			_elm_lang$core$Maybe$Just(chatRoom.id)) ? {
			ctor: '::',
			_0: _rundis$elm_bootstrap$Bootstrap_Table$rowInfo,
			_1: {ctor: '[]'}
		} : {ctor: '[]'};
	});
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_rundis$elm_bootstrap$Bootstrap_Button$button,
						{
							...
							_1: {
								ctor: '::',
								_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(_scameronde$experiment_elm_chat$ChatRooms$DeleteChatRoomAcknowledge),
								_1: {ctor: '[]'}
							}
						},
						{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(_scameronde$experiment_elm_chat$ChatRooms$DeleteChatRoomCancel),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
							{
								ctor: '::',
								_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$id('titleInput'),
								_1: {
									ctor: '::',
						...
						{ctor: '[]'},
						{
							...
							_1: {
								...
								_0: _rundis$elm_bootstrap$Bootstrap_Form_Textarea$textarea(
									{
										ctor: '::',
										_0: _rundis$elm_bootstrap$Bootstrap_Form_Textarea$rows(20),
										_1: {
											ctor: '::',
											_0: _rundis$elm_bootstrap$Bootstrap_Form_Textarea$value(model.messageLog),
											_1: {ctor: '[]'}
										}
									}),
								_1: {
											...
											_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
												{
													...
													_1: {
														ctor: '::',
														_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$value(model.message),
														_1: {
															ctor: '::',
															_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(
											...
											{ctor: '[]'},
											{
												...
												_1: {
													...
													_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
														{
															ctor: '::',
															_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$id('nameInput'),
															_1: {
																ctor: '::',
																_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(
							...
							_0: function () {
								...
								if (_p1.ctor === 'LoginModel') {
									return A2(
										_elm_lang$html$Html$map,
										_scameronde$experiment_elm_chat$ChatClient$LoginMsg,
										_scameronde$experiment_elm_chat$Login$view(_p1._0));
								} else {
									return A2(
										_elm_lang$html$Html$map,
										_scameronde$experiment_elm_chat$ChatClient$ChatMsg,
										_scameronde$experiment_elm_chat$Chat$view(_p1._0));
								}
							}(),
							_1: {ctor: '[]'}
						}),
...
var _scameronde$experiment_elm_chat$ChatClient$subscriptions = function (model) {
	var _p2 = model;
	if (_p2.ctor === 'LoginModel') {
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_scameronde$experiment_elm_chat$ChatClient$LoginMsg,
			_scameronde$experiment_elm_chat$Login$subscriptions(_p2._0));
	} else {
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_scameronde$experiment_elm_chat$ChatClient$ChatMsg,
			_scameronde$experiment_elm_chat$Chat$subscriptions(_p2._0));
	}
};
...
var _scameronde$experiment_elm_chat$ChatClient$update = F2(
	function (msg, model) {
		...
		do {
			if (_p3.ctor === '_Tuple2') {
				if (_p3._0.ctor === 'LoginMsg') {
					if (_p3._1.ctor === 'LoginModel') {
						if (_p3._0._0.ctor === 'Login') {
							return A3(
								_scameronde$experiment_elm_chat$Model$map,
								_scameronde$experiment_elm_chat$ChatClient$ChatModel,
								_scameronde$experiment_elm_chat$ChatClient$ChatMsg,
								_scameronde$experiment_elm_chat$Chat$init(_p3._0._0._0));
						} else {
							return A3(
								_scameronde$experiment_elm_chat$Model$map,
								_scameronde$experiment_elm_chat$ChatClient$LoginModel,
								_scameronde$experiment_elm_chat$ChatClient$LoginMsg,
								A2(_scameronde$experiment_elm_chat$Login$update, _p3._0._0, _p3._1._0));
						}
					} else {
						break _v3_3;
					}
				} else {
					if (_p3._1.ctor === 'ChatModel') {
						return A3(
							_scameronde$experiment_elm_chat$Model$map,
							_scameronde$experiment_elm_chat$ChatClient$ChatModel,
							_scameronde$experiment_elm_chat$ChatClient$ChatMsg,
							A2(_scameronde$experiment_elm_chat$Chat$update, _p3._0._0, _p3._1._0));
					} else {
						break _v3_3;
					}
				}
